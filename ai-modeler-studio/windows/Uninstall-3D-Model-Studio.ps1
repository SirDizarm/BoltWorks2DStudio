...
$desktopShortcut = Join-Path ([Environment]::GetFolderPath("Desktop")) "3D Model Studio.lnk"
$startMenuShortcut = Join-Path $env:APPDATA "Microsoft\Windows\Start Menu\Programs\3D Model Studio.lnk"
...
Write-Host "Removed 3D Model Studio from $installRoot"
